...
sorted_pathways: pathways grouped by category (Hallmarks, Reactome, KEGG…)
...
```{r}
ANALYSIS_1 = readRDS("R_data/DE_PRIMARYvsNORMAL.rds")[["res.noNA"]]
ANALYSIS_2 = readRDS("R_data/DE_CRPCvsNORMAL.rds")[["res.noNA"]]
ANALYSIS_3 = readRDS("R_data/DE_NEPCvsNORMAL.rds")[["res.noNA"]]
